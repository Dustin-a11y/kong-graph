# LongMemEval Official Benchmark Results — Kong Graph 🏆
...
|---------|-----------|:---:|:----:|:----:|
| v1.0 | graph + greedy (flat embed) | 85.7% | — | Apr 7 |
...
| Kong Graph v1.1 (published #1) | 95.8% | 98.85% | 93.2% |
| **Kong Graph v1.2 (this run)** | **98.6%** | **99.4%** | **0.9426** |
